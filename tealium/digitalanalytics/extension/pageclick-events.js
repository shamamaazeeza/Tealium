   ...
   if (typeof (link_obj) !== 'undefined') {
      ...
      if (link_node === "a") {
         ...
         if (nonWhiteSpaceLink) {
            ...
            if (typeof(link_obj.href) !== "undefined" && link_obj.href !== "" ) {
            ...
            if (link_type === "") {
               if (datalayer.DOMAINLIST.split(",").indexOf(link_hrefdomain) == -1 && !/^javascript:.+$|^Blank HREF$|^IPT:.+$/.test(link_href)) {
            ...
            console.log('+++DBDM-LOG > pageclick-events.js: Event captured - eventInfo: \n' + JSON.stringify(eventInfo, null, 2));
            ...
            if (link_type === "DOWNLOAD LINK" || link_type === "EXTERNAL LINK") {
               ...
               console.log('+++DBDM-LOG > pageclick-events.js: Triger Conversion event - eventInfoConv: \n' + JSON.stringify(eventInfoConv, null, 2));
            }
         }
      }
   }
