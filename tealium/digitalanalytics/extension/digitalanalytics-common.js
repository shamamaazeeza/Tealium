...
try {
   ...
   // Needed as part of the load rules for pageview - TO DEPRECATE REQUIREMENT
   ...
   if (typeof(window.ibm_global_data) !== "undefined" && typeof(window.ibm_global_data["Content Category (CDF)"]) !== "undefined" && window.digitalData.page.category.primaryCategory !== window.ibm_global_data["Content Category (CDF)"]) {
	   window.digitalData.page.category.primaryCategory = window.ibm_global_data["Content Category (CDF)"];
