...
window.parseEventName = function(eventName) {
   ...
   try {
      ...
      console.error('+++TME-ERROR > ida_softlayer.js > parseEventName: ' + error);
   }
}
...
var v16elu = {
      ...
      onPageLoad : function(){
         if(window.utag && window.utag.data && window.utag.sender) v16elu.storeTealiumPageviewData();
      },
      ...
      init : function () {
         ...
         try {
            ...
            console.log('+++TME-ERROR > ida_softlayer.js > IBMDependencyRegistry: ' + error);
         }
