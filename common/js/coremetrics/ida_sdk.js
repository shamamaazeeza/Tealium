   ...
   cm.exec = function (b) {
      try {
         ...
         if (cm.initialized) {
            ...
            cm.queue.push({"data": cm.data, "b": b});
            if (!cm.scriptLoaded) {
   ...
   (function () {
      ...
      try {
         ...
         if(typeof (document.domain) !== 'undefined' && document.domain.indexOf('ibm.com') !== -1) {
            window.cmTagQueue.push(['cmSetupCookieMigration', true, true, null, v16elu.domainBlacklist]);
         }

         /* cookie migration code for all non IBM pages */
         if(typeof (document.domain) !== 'undefined' && document.domain.indexOf('ibm.com') == -1){
            window.cmTagQueue.push(['cmSetupCookieMigration', true, true, v16elu.NTPT_DOMAINLIST]);
         }
         ...
         if (digitalData.page.pageInfo.ibm.iniSiteID.toLowerCase() === "ecom") {
            window.cmTagQueue.push(['cmSetupNormalization', 'krypto-_-krypto']); 
         }
         if (digitalData.page.pageInfo.ibm.iniSiteID.toLowerCase() == "p4sc") {
